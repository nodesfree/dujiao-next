      ...
      >
        ...
        <div class="border-t border-border">
          <div v-if="!sidebarCollapsed" class="px-6 py-3 text-[11px] text-muted-foreground space-y-1">
            <p>© {{ new Date().getFullYear() }} Shop-TGaaaa <span v-if="appVersion" class="text-muted-foreground/70">{{ appVersion }}</span></p>
            <a
              href="https://shop.tgaaaa.com"
              target="_blank"
            ...
            >
              ...
              <span>https://shop.tgaaaa.com</span>
            </a>
          </div>
          <button
            type="button"
